...
A reasoning-capable model shows its working and lands on the correct answer, **$0.05 (5 cents)**, not the intuitive 10 cents. The intuitive answer fails because if the ball were 10 cents the bat would be $1.10, making the total $1.20. Working it out step by step catches this.
