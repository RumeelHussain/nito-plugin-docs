...
Web search lets the model pull fresh information from the web into its answer. You do not run anything yourself. When you ask a question, Nito decides whether a search is actually warranted, runs it, folds the results into the answer, and reports what it did. This page covers how to turn it on, the options you can pass, and a couple of worked examples.
