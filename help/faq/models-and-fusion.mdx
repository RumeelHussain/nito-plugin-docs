...
Each model carries a privacy level, and you get that level by choosing that model. A more private model gives a more private call. See [Privacy Levels at a Glance](/models/privacy-tiers-at-a-glance).
