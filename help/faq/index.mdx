...
It depends on the command. A plain `ask` is an ordinary turn in your chat, so it travels upstream with the rest of your conversation. `private` does not: the question and the answer stay out of what your harness sends. See [Privacy](/help/faq/privacy).
