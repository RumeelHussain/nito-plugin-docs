...
The Nito model's own privacy level still applies to the call once it reaches Nito, following the model you chose.
...
2. **How protected must the call itself be?** Choose a model at the [level](/privacy/tiers) that matches, since [the level follows the model](/privacy/tiers).
