...
Per-model cost is distinct from your plan. What your plan includes and what upgrading unlocks are covered in [Plans and Billing](/plans/what-paid-unlocks). For free plan limits, see [Free Usage](/plans/free-usage).
...
- **Confusing per-model cost with your plan.** They are separate; see Plans and Billing.
...
<CardGroup cols={3}>
  ...
  <Card title="Checking Usage" icon="analytics" href="/plans/checking-usage">
    Check your consumption, credits, and balance.
  </Card>
