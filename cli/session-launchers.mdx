...
Anonymous, Private, and Confidential models can power a session. Encrypted models are not part of this release. See [Models](/models) for the catalog and [Privacy Levels](/privacy/tiers) for what each level reaches.
